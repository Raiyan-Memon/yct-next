        ...
        <>
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <button
                        onClick={() =>
                            show ? showNavbar(false) : showNavbar(true)
                        }
                    ...
                    <div
                        ...
                        } overflow-hidden transition-all duration-500 w-full sm:opacity-100 md:max-h-96 md:!block md:w-auto`}
                        id="navbar-default">
                        <ul
                            ...
                            <li>
                                <Link
                                    href="/"
                                    className={`block py-2 px-3 rounded md:bg-transparent  md:p-0 dark:text-white  first-letter ${path == '/' ? 'md:dark:text-blue-500 text-white bg-blue-700 md:text-blue-700' : ''}`}>
                                    Home
                                </Link>
                            </li>
                            <li>
